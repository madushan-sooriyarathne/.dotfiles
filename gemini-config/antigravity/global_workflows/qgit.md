...
- will not reference GEMINI / Google Antigravity in commit messages / descriptions
...
3. **Quality Checks Execution**
   ...
   - **Check GEMINI.md**: Look for quality check commands specified
...
6. **Commit Message Rules**
   ...
   - ❌ **MUST NOT** reference GEMINI or Google Antigravity
