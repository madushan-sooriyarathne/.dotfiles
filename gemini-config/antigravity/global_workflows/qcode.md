...
- Check for the existence of GEMINI.md in the project root
...
10. **Project Configuration Detection**
    ...
    - **Automatic Detection**: Scan for project configuration files
      ...
      - GEMINI.md specified commands and standards
...
11. **Integration with Other Commands**
    ...
    - **Best Practices**: Follow standards from `/qnew` and GEMINI.md
